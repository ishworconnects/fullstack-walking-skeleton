...
This repository is designed as a working baseline for a full-stack web application. It keeps the system intentionally small while proving that the frontend, backend, database, migrations, and browser tests can run together from the start.
