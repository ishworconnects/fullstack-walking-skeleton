...
This repository is designed as a working baseline of  full-stack web application. It keeps a given system intentionally small while proving that the frontend, backend, database, migrations, and browser tests can run together from the start.
